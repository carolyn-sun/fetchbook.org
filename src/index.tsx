	...
	return c.html(
		<Layout title="fetchbook" user={user}>
			<div style={{ marginBottom: "3rem" }}>
				...
				>
					<strong style={{ color: "#212529" }}>
						Uploading from an iPhone/iPad?
					</strong>
					<div
						style={{ marginTop: "0.5rem", fontSize: "0.85rem", color: "#666" }}
					>
						No terminal available? Use this quick form to generate your device
						stats. You can refer to{" "}
						<a href="https://mactracker.ca/">Mactracker</a> for detailed
						information.
					</div>
						...
						>
							...
							>
								...
								<input
									...
									id="ios-os"
									class="form-input"
									placeholder="iOS 26.3.1 (23D8133)"
						...
						>
							...
							>
								<input
									...
									id="ios-display-name"
									class="form-input"
									placeholder="Super Retina XDR OLED display"
