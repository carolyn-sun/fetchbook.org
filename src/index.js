...
const formatFastfetchResult = (type, result) => {
    ...
    if (t === "gpu") {
        if (!Array.isArray(result))
            result = [result];
        return result
            .filter((g) => g.type === "Discrete" || g.type === "Integrated")
            .map((g, index, arr) => {
...
app.get("/user/:username", async (c) => {
    ...
    return c.html(_jsxs(Layout, { title: `${username}'s fetchbook`, user: user, children: [_jsxs("h2", { children: [username, "'s fetchbook"] }), _jsxs("div", { style: {
                    ...
                    alignItems: "center",
                            ...
                            whiteSpace: "pre-wrap",
                            wordBreak: "break-all",
                        }, children: `${origin}/user/${username}` }), _jsx("button", { type: "button", id: "copy-btn", class: "secondary-btn", children: "Copy" })] }), results.length === 0 ? (_jsx("p", { children: "No devices found or they are private." })) : (results.map((row) => (_jsxs("div", { class: "card", children: [_jsxs("div", { class: "card-header-row", children: [_jsxs("div", { class: "card-header-left", children: [isOwner ? (_jsx("form", { method: "post", action: `/api/device/${row.id}/edit`, class: "card-note-form", ...{ onsubmit: "event.preventDefault();" }, children: _jsx("input", { type: "text", name: "note", value: row.note || "", placeholder: "Add a note...", title: "Edit note", maxLength: 32, ...{
                                                onchange: "fetch(this.form.action, { method: 'POST', body: new URLSearchParams(new FormData(this.form)) }); this.blur();",
                                            }, class: "card-note-input" }) })) : row.note ? (_jsx("h3", { class: "card-note-title", children: row.note })) : null, isOwner && (_jsx("div", { class: "card-meta-row", children: row.is_public ? (_jsx("span", { class: "badge badge-public", children: "\uD83C\uDF10 Public" })) : (_jsx("span", { class: "badge badge-private", children: "\uD83D\uDD12 Private" })) }))] }), isOwner && (_jsxs("div", { style: {
                                    display: "flex",
                                    gap: "8px",
                                    alignItems: "center",
                                    flexWrap: "wrap",
